...
namespace BeFitBlazor.DTOs
{
    public class ExerciseExecutionDTO
    {
        ...
        public ExerciseExecutionDTO(ExerciseExecution exerciseExecution)
        {
            ...
            TrainingSessionDisplay = exerciseExecution.TrainingSession != null
                ? $"{exerciseExecution.TrainingSession.Date:yyyy-MM-dd} {exerciseExecution.TrainingSession.StartTime:hh\\:mm} - {exerciseExecution.TrainingSession.EndTime:hh\\:mm}"
                : string.Empty;
